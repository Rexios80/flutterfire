  ...
  DateTimeQueryQuery whereTime({
    ...
    return _$DateTimeQueryQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        ...
        isNull: isNull,
        whereIn:
            whereIn?.map((e) => _$DateTimeQueryPerFieldToJson.time).toList(),
        whereNotIn:
            whereNotIn?.map((e) => _$DateTimeQueryPerFieldToJson.time).toList(),
      ),
      $queryCursor: $queryCursor,
    );
  }
  ...
  TimestampQueryQuery whereTime({
    ...
    return _$TimestampQueryQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        ...
        isNull: isNull,
        whereIn:
            whereIn?.map((e) => _$TimestampQueryPerFieldToJson.time).toList(),
        whereNotIn: whereNotIn
            ?.map((e) => _$TimestampQueryPerFieldToJson.time)
            .toList(),
      ),
      $queryCursor: $queryCursor,
    );
  ...
  GeoPointQueryQuery wherePoint({
    ...
    return _$GeoPointQueryQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        ...
        isNull: isNull,
        whereIn:
            whereIn?.map((e) => _$GeoPointQueryPerFieldToJson.point).toList(),
        whereNotIn: whereNotIn
            ?.map((e) => _$GeoPointQueryPerFieldToJson.point)
            .toList(),
      ),
      $queryCursor: $queryCursor,
    );
  ...
  DocumentReferenceQueryQuery whereRef({
    ...
    return _$DocumentReferenceQueryQuery(
      ...
      $referenceWithoutCursor: $referenceWithoutCursor.where(
        ...
        isNull: isNull,
        whereIn: whereIn
            ?.map((e) => _$DocumentReferenceQueryPerFieldToJson.ref)
            .toList(),
        whereNotIn: whereNotIn
            ?.map((e) => _$DocumentReferenceQueryPerFieldToJson.ref)
            .toList(),
